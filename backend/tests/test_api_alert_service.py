...
class ApiAlertQueryTests(unittest.TestCase):
    def test_query_counts_all_attempts_and_excludes_content_safety(self):
        engine = create_engine("sqlite+pysqlite:///:memory:")
        ...
        self.assertEqual(stats.overall_image_count, 4)
        self.assertEqual(stats.overall_success_count, 2)
